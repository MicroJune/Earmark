...
const styles = StyleSheet.create({
  ...
  card:         { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surface, borderRadius: 12, padding: 14, marginBottom: 10 },
  ...
  hint:         { fontSize: 13, color: COLORS.textSecondary, textAlign: 'center', marginTop: 24, paddingHorizontal: 32, lineHeight: 19 },
  ...
  fabPlusBadge: { position: 'absolute', top: 10, right: 10, width: 18, height: 18, borderRadius: 9, backgroundColor: COLORS.primary, borderWidth: 1.5, borderColor: '#fff', justifyContent: 'center', alignItems: 'center' },
});
